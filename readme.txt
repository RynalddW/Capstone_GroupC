...
twin.py is deployed on Heroku cloud -  alrentively you can spin it up locally it will run on 5001 (twin)
It can be reached wit a URL constructed like this:  https://capstonegrpctwin.herokuapp.com/twin?torque=4&temperature=8423&weight_on_bit=48   and replies with JOSN output 
